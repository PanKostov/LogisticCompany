import { Controller, Body, Get, Patch, Delete, Session, UseGuards } from '@nestjs/common'
...
export class UserController {
  ...
  @UseGuards(AuthGuard)
  async changeName(@Session() session: any, @Body() { userName }: { userName: string }): Promise<User> {
